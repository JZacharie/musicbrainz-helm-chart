...
helm repo update
helm install bookstack geek-cookbook/bookstack
```
...
helm install bookstack \
  --set env.TZ="America/New York" \
    geek-cookbook/bookstack
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install bookstack geek-cookbook/bookstack -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/geek-cookbook/bookstack?modal=changelog)
